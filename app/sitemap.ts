...
const routes = ["", "/pinyin", "/pinyin/initials", "/pinyin/finals", "/pinyin/syllables", "/pinyin/tones", "/pinyin/practice", "/stroke", "/poetry", "/dictionary", "/games/hanzi-match", "/about", "/privacy"];
