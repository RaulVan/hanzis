...
const routes = ["", "/pinyin", "/pinyin/initials", "/pinyin/finals", "/pinyin/syllables", "/pinyin/tones", "/pinyin/practice", "/stroke", "/poetry", "/dictionary", "/about", "/privacy"];

export const dynamic = "force-static";

export default function sitemap(): MetadataRoute.Sitemap {
  const base = "https://hanzis.com";
  return [
