...
export const metadata = pageMetadata(
  "/poetry/",
  "古诗词学习 · 诗词原文、精选拼音与海棠资料",
  "阅读校对精选与海棠诗社诗词资料，按朝代、作者和选集查找原文；精选提供拼音，支持朗读、收藏、背诵和选段生成字帖。",
);
export default function PoetryPage() {
  ...
  return <>
    ...
    <section aria-labelledby="poetry-reading-index" className="mt-12 space-y-5 border-t border-border pt-8">
      ...
      <p className="body-copy">本站校对精选 {poems.length} 首唐宋诗词，每首提供原文、拼音、译文与学习注释。上方另可浏览海棠诗社 {manifest.counts.works.toLocaleString("zh-CN")} 篇来源资料。选择诗名进入独立阅读页，也可以朗读、练习背诵或生成字帖。</p>
